...
export default function (sandbox) {
  ...
  /**
   * Fetches all users in the datastore
   * @returns {Array}
   */
  ...
  /**
   * @param {String} emailAddress - an user email address
   * @returns {Object}
   */
  ...
  /**
   * @param {String} emailAddress - email address of the user 
   * @returns {String} - the hashed password associated with user email address
   */
