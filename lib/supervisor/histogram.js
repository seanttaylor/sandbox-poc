 ...
 * @property {Object.<String, Number>} serviceName - the name of the module reporting an 
 * error mapped to a current count of specified errors for that module
 */

/**
 * Builds a histogram; returns an API for displaying and analyzing data; used by the [Supervisor]{@link module:Supervisor} module.
 * @module Histogram
 */
function Histogram() {
  /** @type {MyHistogram} */
