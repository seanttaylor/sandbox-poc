...
/**
 * Monitors, measures and tracks errors reported by client-defined modules; alerts the application core when specified error thresholds are 
 * reached triggering the `application.error.globalErrorThresholdExceeded` event.
 * 
