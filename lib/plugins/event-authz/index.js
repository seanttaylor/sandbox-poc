...
/**
 * Extends the existing application events API to apply permissions to modules that subscribe to a given event.
 * Plugin methods defined below are exposed on the application core under the `sandbox.my.plugins['/plugins/events-authz']` namespace.
 * @param {Object} sanbox - default sandbox APIs 
 * @module Plugin/EventsAuthz
 */
export default function pluginEventAuthz(sandbox) {
    ...
    /**
     * Ensures a subscriber is allowed to subscribe to an event
     ...
     * @memberof module:Plugin/EventsAuthz
     */
