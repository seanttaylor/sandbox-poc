...
/**
 * Exposes an API for creating, running and monitoring chaos experiments; used by the [Chaos]{@link module:Plugin/Chaos} plugin.
...
/**
 * A plugin that instruments chaos experiments. Plugin methods defined below are exposed on the application core under 
 * the `sandbox.my.plugins['/plugins/chaos']` namespace.
