...
export default function PostService(sandbox) {
    ...
    */
     function onApplicationReady() {
       events.notify('chaos.event.registrationRequested', {
        experimentName: 'unsetRepository',
        startExperiment: function() {
            // create a functioning copy `myRepository` so we can restore functionality at the end of the experiment
            //restoreRepo = Object.assign({}, myRepository);
            setRepository({});
        },
        endExperiment: function() {
            setRepository(reserveRepo)
        }
       });
    }
